...
class RecipeModelTest(TestCase):
    ...
    def setUpTestData():
       ...
       Recipe.objects.create(name = 'Tea', cooking_time = 5, ingredients = 'tea-leaves, water, sugar', description = 'Add tea leaves to boiling water, then add sugar')
    ...
    def test_difficulty_calculation(self):
       recipe = Recipe.objects.get(id=1)                              # TEST TO CHECK calculate_difficulty() FUNCTIONALITY
